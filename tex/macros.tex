...
\renewcommand{\proofname}{\bf Démonstration}
...
%%% ===== Couleur des liens =====
%\definecolor{linkcolor}{RGB}{0,0,180}
\definecolor{linkcolor}{RGB}{99,0,60} % l14-33 :
\PassOptionsToPackage{
    colorlinks=true,
    linkcolor=linkcolor,
    citecolor=linkcolor,
...
\hypersetup{
  ...
  pdfauthor={Guillaume THÉMÈZE <guillaume.themeze@gmail.fr>},
  pdfkeywords={LaTeX, quantum, bosons, dynamique , hors équilibre, integrable, Bethe ansatz, Généralized Gibbs Ensemble , quench, fluctuations , hydrodynamique, Lieb-Liniger, Généralized Hydrodynamics , MFT, thermodynamique},
  colorlinks=true
}

%%% ===== Style des titres (colorés) =====
\titleformat{\chapter}[display]{\normalfont\sffamily\huge\bfseries\color{linkcolor}}{\chaptertitlename\ \thechapter}{20pt}{\Huge}
\titleformat{\section}{\normalfont\color{linkcolor!90!colorFour}\Large\bfseries}{\thesection}{1em}{}
\titleformat{\subsection}{\normalfont\color{linkcolor!70!colorFour}\large\bfseries}{\thesubsection}{1em}{}
\titleformat{\subsubsection}{\normalfont\color{linkcolor!50!colorFour}\normalsize\bfseries}{\thesubsubsection}{1em}{}
\titleformat{\paragraph}[runin]{\normalfont\color{linkcolor!30!colorFour}\bfseries}{\theparagraph}{1em}{}
\titleformat{\subparagraph}[runin]{\normalfont\color{linkcolor!10!colorFour}\itshape}{\thesubparagraph}{1em}{}

%%% ===== Couleurs de la table des matières =====
%\renewcommand{\cftchapfont}{\fontsize{12pt}{14pt}\selectfont }
\renewcommand{\cftsecfont}{\color{linkcolor!90!black}}
\renewcommand{\cftsubsecfont}{\color{linkcolor!70!black}}
\renewcommand{\cftsubsubsecfont}{\color{linkcolor!50!black}}
\renewcommand{\cftparafont}{\color{linkcolor!30!black}}
...
\fancyfoot[L]{Manuscrit de Thèse de Doctorat -- G.THÉMÈZE}
%\fancyfoot[R]{Paris, \mydatetime\today{} -- Période 2022--2025}
%\fancyfoot[R]{Paris, \DTMnow -- Période 2022--2025}
%\fancyfoot[R]{Paris,  Période 2022--2025}
%\fancyfoot[R]{Paris, le \DTMdate\today{} à \DTMcurrenttime -- Période 2022--2025}
%\fancyfoot[R]{Paris, le \DTMdisplaydate{\the\year}{\the\month}{\the\day}{-} à \DTMcurrenttime -- Période 2022--2025}
\fancyfoot[R]{Paris, le \today{} à \DTMcurrenttime -- Période 2022--2025}
...
%\newcommand{\operator}[1]{\widehat{\bm{#1}}} % pour les operaeur vecteur
