...
%\usepackage{minitoc}
\setcounter{minitocdepth}{6} % profondeur affichée pour les mini-sommaires
...
% Heading pour la biblio de l'introduction
\defbibheading{subbibliographyintro}{%
  %\subsection*{Bibliographie de l'Introduction}%
  \subsection*{Bibliographie}%
}

% Heading pour la biblio par chapitre
\defbibheading{subbibliography}{%
  %\subsection*{Bibliographie du chapitre}%
  \subsection*{Bibliographie}%
}

% Heading pour la biblio des annexes
\defbibheading{annexbibliography}{%
  %\subsection*{Bibliographie de l’annexe}%
  \subsection*{Bibliographie}%
}
