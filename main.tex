...
\addtocontents{toc}{\protect\setcounter{tocdepth}{6}} % pour afficher jusqu'aux subsubsections dans le sommaire
\pdfbookmark[0]{Table des matièresssssss}{tablematieres} % pour ajouter la table des matières dans l'``index'' du fichier compilé
\tableofcontents
\mainmatter
