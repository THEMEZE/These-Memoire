...
\newcommand{\CoupureUnZeroDiagram}[0]{
	...
	\draw[opacity = 0.5 , dashed , dash pattern=on 6pt off 3pt, line width=1.8ex , color = \colorTwo , fill = none] 
		...
		(-7,7) edge []node [pos=1.1, right ]{\huge $\partial \Gamma_{t=0}^b $ } ( -6.5  , 7 )	 
	;
...
\newcommand{\CoupureUnVeffDiagram}[0]{
		...
		\begin{tikzpicture}[transform canvas={scale=1}] 
			...
			\draw
    			(0.45, 0.2) edge[line width=1.8ex, color=\colorTwo] 
        						node[pos=1.0, below]{ \color{\colorTwo}\huge $x_b/t$} (0.45, -0.2)
        		(0.2 , 1.45 ) edge[line width=1.8ex, color=\colorTwo] 
        						node[pos=1.1, left ]{ \color{\colorTwo}\huge $\theta_b$} (-0.2 , 1.45 )
	...
	\draw[opacity = 0.5 , dashed , dash pattern=on 6pt off 3pt, line width=1.8ex , color = \colorTwo , fill = none] 
		...
		(-7,7) edge []node [pos=1.1, right ]{\huge $\partial \Gamma_t^b \, \& \, v^{\mathrm{eff}}$ } ( -6.5  , 7 )	 
	;
...
\newcommand{\CoupureDeuxZeroDiagram}[0]{
	...
	\node at (0,0) [circle, ] {
		\begin{tikzpicture}[transform canvas={scale=1}] 
			...
			\draw
    			(0.45, 0.2) edge[line width=1.8ex, color=\colorTwo] 
        						node[pos=1.1, below]{ \color{\colorTwo}\huge $x_b$} (0.45, -0.2)
        		(0.2 , 1.4 ) edge[line width=1.8ex, color=\colorTwo] 
        						node[pos=1.1, left ]{ \color{\colorTwo}\huge $\theta_g$} (-0.2 , 1.4 )
