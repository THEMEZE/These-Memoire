...
\normalsize
\color{black}
\Large{\textit{Study of the out-of-equilibrium dynamics of one-dimensional Bose gases}} \\
%*****************************************************
...
\small École doctorale n$^{\circ}$572, Ondes et Matières\\
\small Spécialité de doctorat: Physique\\
\small Graduate School : Physique, Référent : Faculté des Sciences d'Orsay \\
\vspace{6mm}

\footnotesize Thèse préparée au \textbf{Laboratoire Charles Fabry} (Université Paris-Saclay, CNRS, Institut d’Optique Graduate School), sous la direction de \textbf{Isabelle BOUCHOULE}, Directrice de thèse. \\
\vspace{10mm}

{\textbf{Thèse soutenue à PALAISEAU, le 4 novembre 2025, par}}\\[5mm]
\bigskip
\Large {\color{Prune} \textbf{Guillaume THÉMÈZE}} % Changer le Prénom et le NOM
...
\textbf{Dmitry PETROV} &  Examinateur \\ 
