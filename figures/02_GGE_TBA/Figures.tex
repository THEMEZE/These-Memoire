...
\begin{tikzpicture}
   ...
   ; 
    ...
    \draw[thick, color=\colorThree, fill=\colorThree , opacity = 0.8] (4,3) ellipse [x radius=0.8, y radius=0.3];
...
\begin{axis}[
    ...
    width=10cm,
    height=6cm,
    legend style={at={(0.7,0.1) , opacity = 0.8}, anchor=south east, font=\small}
]
