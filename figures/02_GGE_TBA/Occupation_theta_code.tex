...
\begin{scope}
	...
	\begin{scope}[shift={(-0,0)},rotate=0,opacity=1,color=black]
		...
		\begin{scope}[shift={(0.5,0.5)}]
            ...
            \node[anchor=west, font=\bfseries] at (0.2, 0) {\color{\colorSix} : quasi-particule};
		\end{scope}
		...
		\begin{scope}[shift={(0.5,-0.5)}]
            ...
            \node[anchor=west, font=\bfseries] at (0.2, 0) {\color{\colorSix} : hole};
		\end{scope}
	...
	\begin{scope}[shift={(6,0)},rotate=0,opacity=1,color=black]	
		...
		\node[anchor=west] at (0.4, 0.5) {\color{\colorFour} $\rho$ };\node[anchor=west, font=\bfseries] at (0.9, 0.5) {\color{\colorFour}: quasi-particule distribution};
		
		\node[anchor=west] at (0.4, -0.5) {\color{\colorFour} $\rho_h$ };\node[anchor=west, font=\bfseries] at (0.9, -0.5) {\color{\colorFour}  : hole distribution};
	...
	\begin{scope}[shift={(14.5,0)},rotate=0,opacity=1,color=black]	
		...
		\node[anchor=west] at (0.2, 0) {\color{\colorFour} ${\color{\colorFive}\rho_s} = \rho + \rho_h $ } node[anchor=west , font=\bfseries] at (2.8 , 0 )  {\color{\colorFour} {\color{\colorFive} : density of states}};
