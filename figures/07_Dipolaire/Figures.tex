...
\begin{tikzpicture}[node distance=1.8cm and 1.2cm]
  ...
  \node[below=-1.15cm of fiberinput] {\color{\colorSix} \tiny  Fibre};
...
%	\node[mirror, rotate=-45, above=2cm of mirrord1] (mirrord2) {};
  ...
  \node[fiber ,  left=5mm of collimateuroutput , xscale = -1 ] (fiberoutput) {};
  \node[below=-1.15cm of fiberoutput] {\color{\colorSix} \tiny  Fibre};
