...
\paragraph*{Chapitre \ref{chap:LL-BA} : Modèle de Lieb-Liniger et approche Bethe Ansatz.}  
...
\paragraph*{Chapitre \ref{chap:relaxation} : Relaxation et Équilibre dans les Systèmes Quantiques Intégrables : de l’Ensemble de Gibbs Généralisé à la Thermodynamique de Bethe.}  
...
\paragraph*{Chapitre \ref{chap:GHD} : Dynamique hors-équilibre et hydrodynamique généralisée.}  
...
\paragraph*{Chapitre \ref{chap:Fluctu} : Fluctuations de la distribution de rapidités dans les états stationnaires du modèle de Lieb–Liniger homogène.}  
...
\paragraph*{Chapitre \ref{chap:disp.exp} : Dispositif expérimental.}  
...
\paragraph*{Chapitre \ref{chap:bipartite} : Étude du protocole de bi-partition : Mesure de distribution de rapidités locales $\rho(x , \theta ) $  pour des systèmes hors équilibre.}
...
\paragraph*{Chapitre \ref{chap:dipolaire} : Potentiel dipolaire et perspectives expérimentales.}  
...
\begin{itemize}[label = $\bullet$]
    \item Le chapitre \ref{chap:Fluctu} s’appuie sur le chapitre \ref{chap:relaxation}, lui-même basé sur le chapitre \ref{chap:LL-BA}.  
    \item Le chapitre \ref{chap:dipolaire} se fonde sur le chapitre \ref{chap:bipartite}, qui fait référence au chapitre \ref{chap:GHD}, lequel repose sur le chapitre \ref{chap:relaxation}.  
\end{itemize}
