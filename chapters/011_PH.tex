...
\begin{eqnarray}
    \operator{H}\vert \psi ( \theta_1 , \cdots , \theta_N ) \rangle &= &  \frac{1}{ \sqrt{N!}} \int d^N z \,      \left [ \operator{\mathcal{H}}_N \, \varphi_{\{ \theta_a \}} ( \{x_a\})\,  \right ] \, \operator{\Psi}^\dag(z_1) \cdots  \cdots\operator{\Psi}^\dag(z_N) \vert \emptyset \rangle
\end{eqnarray}
avec
\begin{eqnarray}
