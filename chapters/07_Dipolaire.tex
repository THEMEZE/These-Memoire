...
\begin{eqnarray}
	\Omega(\vec{r}) & = & -  \bra{e} \operatorvec{D} \cdot \operatorvec{\mathcal{E}}(\vec{r}) \ket{g}/\hbar\\
	& = &- \vec{d}_{\scriptscriptstyle g\leftrightarrow e } \cdot  \vec{\mathcal{E}}(\vec{r}) /\hbar,	
\end{eqnarray}
...
\begin{equation}
	...
	| \vec{d}_{\scriptscriptstyle g \leftrightarrow e} |^2,
\end{equation}
