...
\begin{eqnarray}
	...
	& = &- \vec{d}_{e\leftrightarrow g } \cdot  \vec{\mathcal{E}}(\vec{r}) /\hbar,	
\end{eqnarray}


avec $\vec{d}_{\scriptscriptstyle e\leftrightarrow g } = \bra{e} \operatorvec{D} \ket{g} $ l’élément de matrice dipolaire réel entre $\ket{g}$ et $\ket{e}$. 
