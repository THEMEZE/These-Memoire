...
\begin{itemize}[label = $\bullet$]
  ...
  \item \textbf{Inclusion des effets de pertes atomiques} : s’appuyer sur la récente modélisation de l’évolution de la distribution de rapidités sous pertes atomiques (Bouchoule, Doyon, Dubail, 2020) pour étudier les déviations non thermiques et les intégrer dans le cadre GHD \cite{10.21468/SciPostPhys.9.4.044}.
