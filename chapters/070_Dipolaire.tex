...
On suppose que le champ laser est {\bf désacordé par rapport à la résonance} et que le désaccord
\(
...
L’hamiltonien total du système « atome + champ » s’écrit alors \cite{CohenTannoudji1988} :
\begin{eqnarray}
...
Les conditions des Eqs.~\eqref{eq:7.49} et \eqref{eq:7.50} impliquent alors, en utilisant les expressions \eqref{eq:7.47} et \eqref{eq:7.48} pour le potentiel dipolaire et le taux de diffusion de photons, que la puissance laser doit satisfaire
\begin{equation}
...
La région vérifiant le critère ci-dessous est représentée sur la figure~\eqref{fig:7.6}, dans un diagramme (\(\lambda, P\)) où \(\lambda\) est la longueur d'onde du laser.  
