...
P_{\rm max}(\lambda) &= \Gamma_{\rm sc}^{(max)} \cdot \frac{\pi w_0^2}{2} \frac{8 I_{\rm sat}}{\Gamma^3} 
...
Pour un courant d’injection de $1.5\,\text{A}$ dans le TA, la puissance mesurée en sortie, après passage dans le modulateur acousto-optique \gls{AOM}, atteint environ $62\,\text{mW}$. 
