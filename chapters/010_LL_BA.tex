...
Sans en faire ici la démonstration, donnons une forme généralisée de la fonction propre à $N$ particules (Eq~ \eqref{chap.1:eq.rapel.fonction.propre.N}), qui prolonge naturellement l’expression obtenue pour le cas à deux corps (Eq~ \eqref{eq:I-1-10}).
