...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth , page = 2 ]{figures/01_LL_BA/Figures.pdf}
    \caption{
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.1\textwidth , page = 3 ]{figures/01_LL_BA/Figures.pdf}
    \caption{
	Illustration de la relation entre la densité d’états $\rho_s(\theta)$ et les nombres quantiques fermioniques $I_a$. Les rapidités dans l’intervalle $[\theta, \theta + \delta\theta]$ s’associent à un ensemble de nombres quantiques fermioniques situés dans $[I, I + \delta I]$. La densité d’états $\rho_s$ se déduit alors de la relation $\delta I \simeq L \rho_s(\theta) \delta \theta $
    }
    \label{fig:rho_s.I}
\end{figure}
