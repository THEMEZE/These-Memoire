...
La matrice de fluctuation \( \mathcal{H}(\theta, \theta') \)  , définie par \eqref{chap:fluctu:eq:hessienne3}, est obtenue en combinant ces deux contributions. L’inverse \( \left(L \mathcal{H} \right)^{-1}(\theta, \theta') \) en \eqref{chap:fluctu:eq:fluctuations.10} fournie une partie sans interaction (diagonale) $(L\mathcal{D})^{-1}(\theta, \theta')$ et une partie avec intéraction $\mathcal{B}(\theta, \theta')/L$ avec \eqref{chap:fluctu:eq:B.1}.
