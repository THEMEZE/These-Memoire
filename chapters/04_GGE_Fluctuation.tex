...
On choisit 
\begin{eqnarray*}
	\gamma = 10^{-1.7}, \quad t =  89.125.	
\end{eqnarray*}
Ce paramètre est représenté par un {\bf point rouge} dans le diagramme de phase du modèle de \gls{LL}, présenté en figure~\ref{chap:4:fig:diagr}.
