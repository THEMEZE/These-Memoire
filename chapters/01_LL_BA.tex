...
En prenant le logarithme du membre gauche et du membre droit de l’équation~\eqref{eq:bethe_exp}, on généralise l'équation \eqref{eq:Bethe2}. On obtient :
...
Intéressons-nous maintenant à la {\em densité de particules dans l’espace des moments}, que l'on nome la {\bf distribution de rapidité} et notée \( \rho(\theta) \), et définie par
\begin{eqnarray*}
	\rho(\theta_a) = \underset{\text{therm}}{\lim} \frac{1}{L} \cdot \frac{1}{\theta_{a+1} - \theta_a} > 0.
\end{eqnarray*}
...
\begin{eqnarray}
	\frac{1}{L} \sum_{b = 1}^N \Delta(\theta_a - \theta_b) \underset{\text{therm}}{\longrightarrow }\int_{-\theta_{\mbox{\tiny max}}}^{+\theta_{\mbox{\tiny max}}} \Delta(\theta_a - \theta)\, \rho(\theta)\, d\theta.
\end{eqnarray}
