...
\begin{enumerate}[label=\roman*)]
	...
	\begin{eqnarray}
		\left \{ \begin{array}{rcll} \varphi_k  & = & \displaystyle \frac{1}{\sqrt{L}} e^{+ikx} & \mbox{état avec impulsion $+\hbar k $ } \\ \varphi_{\overline{k}}  & = & \displaystyle \frac{1}{\sqrt{L}}e^{-ikx} & \mbox{état avec impulsion $-\hbar k $ }\end{array}\right.
	\end{eqnarray}
	Cela correspond à des états propres de l’opérateur impulsion $\operator{p} = -i \hbar \operator{\partial}_x$, avec valeurs propres opposées.
	\item Base symétrique / antisymétrique  
	\begin{eqnarray}
