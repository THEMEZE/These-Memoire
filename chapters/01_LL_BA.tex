...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth , page = 2 ]{figures/01_LL_BA/Figures.pdf}
    \caption{
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth , page = 3 ]{figures/01_LL_BA/Figures.pdf}
    \caption{
