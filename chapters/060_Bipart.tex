...
\begin{itemize}[label=$\bullet$]
    ...
    \item le profil de densité après l’application du faisceau pousseur, après un délai incompressible de $1~\mathrm{ms}$ (courbe xx de la figure~\ref{fig:6.3}).
\end{itemize}
...
La densité d’atomes \(n(x,\tau)\) est obtenue à partir des équations \eqref{eq:contour_support} et (xx).  
