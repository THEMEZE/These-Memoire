...
Dans la limite thermodynamique, $w(\theta)$ sert de donnée d’entrée pour les équations de la \gls{TBA}, qui permettent, par un calcul numérique, de reconstruire la distribution de rapidité à partir de $w(\theta)$.  
