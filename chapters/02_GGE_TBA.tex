...
\section{Dérivée fonctionnelle comme dérivée directionnelle}
...
\begin{equation}
D[\lambda] F[\phi] \equiv \lim_{\epsilon \to 0} \frac{F[\phi + \epsilon \lambda] - F[\phi]}{\epsilon}
\end{equation}

La quantité $D[\lambda] F[\phi]$ est linéaire en $\lambda(x)$, et peut donc s’écrire sous forme d’un produit scalaire dans l’espace fonctionnel :

\begin{equation}
D[\lambda] F[\phi] = \int dx \, \frac{\delta F[\phi]}{\delta \phi(x)} \lambda(x)
\end{equation}
