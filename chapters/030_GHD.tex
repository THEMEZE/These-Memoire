...
En utilisant la représentation de Madelung $\psi(x,t) = \sqrt{n(x,t)}\, e^{i\theta(x,t)}$, on obtient les équations dites hydrodynamiques de la forme de \eqref{chap:3:eq:hydro.1} \cite{Spiegel1980FluidDF,10.1093/acprof:oso/9780198758884.001.0001} :  
\begin{eqnarray}
...
\begin{itemize}[label=$\cdot$]
	...
	\item L'énergie est dominée par les termes cinétiques classiques, justifiant l'utilisation de l'équation de Madelung hydrodynamique.
\end{itemize}
